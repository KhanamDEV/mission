...
@section('content')
    <section id="wrap-user-new">
        <form method="POST" class="wrap-form" id="upload-user" enctype="multipart/form-data">
            @csrf
            ...
            <div class="wrap-button-new text-center">
                <button type="button" id="submit-form" disabled
                        class="btn bg-blue">@lang('admin::layer.user.button_upload')</button>
                <p>@lang('admin::layer.user.template_file_user')<a href="{{asset('data/user.csv')}}"
                                                                   title="">@lang('admin::layer.user.download')</a></p>
            </div>
        </form>
    </section>
@endsection
