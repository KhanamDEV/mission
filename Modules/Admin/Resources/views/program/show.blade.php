    ...
    <section id="wrap-user-detail">
        <div class="box-detail bg-white">
            <div class="detail-user-item text-center">
                <img src="{{empty($program->thumbnail_url) ? asset('static/admin/images/detail-selected.png') : \App\Helpers\Helpers::getUrlImg($program->thumbnail_url)}}" alt="" class="img_detail">
                        ...
                        <tbody>
                            @foreach ($missions as $mission)
                                <tr>
                                    ...
                                    <td>
                                        <a data-mission-id="{{$mission->id}}" href="javascript:void(0)"  class="control-arrow mission-show">
                                            <img src="{{ asset('static/admin/images/icon-arrow.png') }}" alt="">
                                        </a>
                                    </td>
                                </tr>
                            @endforeach
            ...
            <div class="modal-content margin-top-70">
                <div class="bg-white">
                    <div class="wrap-detail-program text-center">
                        <img class="mission-thumb img_detail" src="" alt="">
