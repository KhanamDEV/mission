                ...
                <table class="table wrap-table">
                    ...
                    <tbody>
                        @foreach ($data['programs'] as $program)
                            <tr>
                                <td class="box-name">
                                    <a href="{{route('admin.program_show', ['id' => $program->id])}}" title=""><img class="image-team"
                                            src="{{\App\Helpers\Helpers::getUrlImg($program->thumbnail_url)}}" alt=""></a>
                                    <div class="name">
                                        <a href="{{route('admin.program_show', ['id' => $program->id])}}" title="">{{$program->name}}</a>
                                        <p class="text-less">{{$program->detail}}</p>
                                    </div>
                                </td>
                                <td>
                                    <a href="{{route('admin.program_show', ['id' => $program->id])}}" class="control-arrow"><img
