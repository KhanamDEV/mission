    ...
    <section id="wrap-user">
        <div class="wrap-list-user bg-white">
            <div class="wrap-button text-center d-flex justify-content-center misson-base-title">
                ...
                <a href="{{route('manager.notification_create', ['brand_id' => request()->route('brand_id')])}}" class="btn bg-blue btn-subcribe" title="">@lang('manager::layer.notification.create')</a>
            </div>
            <div class="wrap-list">
                <table class="table wrap-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{route('manager.notification_show', ['brand_id' => request()->route('brand_id'), 'id' => $notify->id])}}" class="control-arrow"><img src="{{asset('static/manager/images/icon-arrow.png')}}" alt=""></a>
                        </td>
                    </tr>
                    @endforeach
                    </tbody>
