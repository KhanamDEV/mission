...
@section('content')
    <section id="wrap-user-new">
        ...
        <div class="list-file bg-white">
            <table class="table wrap-table">
                ...
                <tbody>
                @foreach($data['logUpdateUsers'] as $logUpdateUser)
                    <tr>
    ...
    @endsection
@section('validate')
    {!! JsValidator::formRequest('Modules\Manager\Http\Requests\CreateUserRequest', '#update-user') !!}
@endsection
@section('script')
            ...
            $("#submit-form").click(function () {
                if(fileUser == undefined){
                    ...
                    if (!error) {
                        ...
                        $.ajax({
                            url: "{{route('manager.user_edit', ['brand_id' => request()->route('brand_id')])}}",
                            type: 'POST',
                            data: formData,
                            contentType: false,
                            processData: false,
